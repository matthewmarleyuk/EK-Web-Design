...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* Hero Section */}
      <section className="relative pt-28 pb-16 lg:pt-36 lg:pb-20" id="hero">
        <div className="container">
          <div className="text-center max-w-4xl mx-auto">
            <div className="inline-flex items-center px-4 py-2 mb-8 rounded-full bg-white/10 backdrop-blur-sm border border-white/10">
              <span className="text-sm font-medium">East Kilbride Web Design Agency</span>
            ...
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-black/30 backdrop-blur-sm">
              <div className="flex -space-x-2 mr-3">
                <img className="w-8 h-8 rounded-full border-2 border-purple-900" src="https://randomuser.me/api/portraits/men/32.jpg" alt="User" />
                <img className="w-8 h-8 rounded-full border-2 border-purple-900" src="https://randomuser.me/api/portraits/women/44.jpg" alt="User" />
                <img className="w-8 h-8 rounded-full border-2 border-purple-900" src="https://randomuser.me/api/portraits/men/46.jpg" alt="User" />
              </div>
              <span className="text-sm font-medium">Trusted by <span className="font-bold">100's</span> of clients</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="why-us">
        <div className="container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="glass p-6 flex flex-col items-start h-full">
              <div className="mb-6">
              ...
              <p className="text-white/70">Our designers and developers bring years of experience creating high-performing websites.</p>
            </div>
            ...
            <div className="glass p-6 flex flex-col items-start h-full">
              ...
              <p className="text-white/70">We write maintainable, efficient code that ensures your website runs smoothly.</p>
            </div>
            ...
            <div className="glass p-6 flex flex-col items-start h-full">
              ...
              <p className="text-white/70">All our websites work perfectly on any device, from desktop to mobile.</p>
            </div>
            ...
            <div className="glass p-6 flex flex-col items-start h-full">
              ...
              <p className="text-white/70">We build websites with search engines in mind to help you rank higher.</p>
            </div>
            ...
            <div className="glass p-6 flex flex-col items-start h-full">
              ...
              <h3 className="text-xl font-semibold mb-3">Easy to Manage</h3>
              <p className="text-white/70">Our content management systems are intuitive and user-friendly.</p>
            </div>
            ...
            <div className="glass p-6 flex flex-col items-start h-full">
              ...
              <p className="text-white/70">We're here to help long after your website launches with dedicated support.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="section" id="services">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-white/80">
              Comprehensive web solutions tailored to your specific business needs and goals.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={index} className="glass-darker overflow-hidden group">
                <div className="p-8">
                ...
                <div className="bg-purple-700/50 px-8 py-4 flex justify-between items-center">
      ...
      <section className="section" id="process">
        <div className="container">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="text-white/80">
              We follow a proven, structured approach to deliver websites that exceed expectations.
            </p>
          </div>
                ...
                {[
                  {
                    number: '01',
                    title: 'Discovery',
                    description: 'We learn about your business, goals, and requirements to establish a clear project vision.'
                  },
                  {
                    number: '02',
                    title: 'Planning',
                    description: 'We create a detailed roadmap that outlines the site structure, features, and timeline.'
                  },
                  {
                    number: '03',
                    title: 'Design',
                    description: 'Our designers craft visually stunning layouts that align with your brand identity.'
                  },
                  {
                    number: '04',
                    title: 'Development',
                    description: 'We build your website using clean, efficient code and modern development practices.'
                  },
                  {
                    number: '05',
                    title: 'Testing & Launch',
                    description: 'We rigorously test your website before launching it to ensure everything works perfectly.'
                  },
                  {
                    number: '06',
